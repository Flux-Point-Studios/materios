...
// on 2026-05-06; do not edit. Patches via README.md in this dir.
//
// SPDX-License-Identifier: MIT (see ./LICENSE)
// Original path: pallets/acurast/common/src/attestation/error.rs
//
// [materios-patch] Removed `impl From<p384::elliptic_curve::Error>` — upstream
// p384 v0.13 still re-exports `elliptic_curve::Error` but the call site in
// attestation.rs has been rewritten to construct P-384 keys via
// `p384::PublicKey::from_sec1_bytes` and map errors to ParseP384PublicKey
// directly via `or(Err(...))`. The blanket From impl was Acurast-fork-specific.
